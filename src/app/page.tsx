...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="relative h-auto md:min-h-screen flex items-center justify-center pt-28 pb-8 md:pt-24 md:pb-24 overflow-hidden bg-[#0a2540] z-20">
        ...
        >
          <Image
            ...
            fill
            className="object-cover object-center blur-[1px] opacity-90 hidden md:block"
            priority
          />
          {/* Darker Overlay Gradient for better contrast */}
          <div className="absolute inset-0 bg-gradient-to-b from-[#0a2540] md:from-[#0a2540]/90 md:via-[#0a2540]/60 to-[#0a2540]"></div>
        </motion.div>

        <div className="relative z-10 w-full max-w-full overflow-hidden px-2 sm:px-6 lg:px-8 text-center mt-4 md:mt-8">
          {/* Hybrid Mode Badge */}
          <motion.div 
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.5, duration: 0.5 }}
            className="inline-block px-8 py-2.5 rounded-full border border-white/20 bg-white/10 backdrop-blur-md shadow-xl text-white font-bold text-sm tracking-[0.2em] uppercase mb-4 md:mb-10"
          >
            (Hybrid Mode)
          </motion.div>
          ...
          <motion.h1 
            ...
            initial="initial"
            animate="whileInView"
            className="font-heading font-black leading-[1.1] mb-6 md:mb-16 flex flex-col items-center gap-2 md:gap-6 w-full"
          >
